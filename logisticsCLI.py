...
from mylib.logistics import get_distance, total_distance, estimate_travel_time
import click
...
def travel_time(city1, city2, speed):
    ...
    try:
        ...
        click.echo(
            f"The estimated travel time between {city1} and {city2} at {speed} km/h is {time:.2f} hours."
        )
    except ValueError as e:
        click.echo(str(e))
